...
void cache_init(void)
{
	...
	ctp = cache_tabent_base = (cache_tabent *)gtm_malloc_intern(CACHE_TAB_SIZE * sizeof(cache_tabent));
	...
	cache_stealp = cache_entry_base = (cache_entry *)gtm_malloc_intern((CACHE_TAB_ENTRIES) * sizeof(cache_entry));
